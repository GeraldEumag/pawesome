...
import "./CustomersProfile.css";

const CustomersProfile = () => {
  const [customers, setCustomers] = useState([
    { id: "CUST-001", name: "John Smith", phone: "+1-234-567-8901", email: "john.smith@email.com", address: "123 Main St, City, State 12345", joinDate: "2024-01-15", totalBookings: 12 },
    { id: "CUST-002", name: "Emily Davis", phone: "+1-234-567-8902", email: "emily.davis@email.com", address: "456 Oak Ave, City, State 67890", joinDate: "2024-02-20", totalBookings: 8 },
    { id: "CUST-003", name: "Robert Wilson", phone: "+1-234-567-8903", email: "robert.wilson@email.com", address: "789 Pine Rd, City, State 11111", joinDate: "2024-01-10", totalBookings: 15 },
    { id: "CUST-004", name: "Jessica Brown", phone: "+1-234-567-8904", email: "jessica.brown@email.com", address: "321 Elm St, City, State 22222", joinDate: "2024-03-05", totalBookings: 6 },
    { id: "CUST-005", name: "Michael Johnson", phone: "+1-234-567-8905", email: "michael.johnson@email.com", address: "654 Maple Dr, City, State 33333", joinDate: "2024-02-15", totalBookings: 10 },
  ]);

  const [pets, setPets] = useState([
    { id: "PET-001", customerId: "CUST-001", name: "Buddy", type: "Dog", breed: "Golden Retriever", age: "3 years", image: "https://picsum.photos/seed/dog1/100/100" },
    { id: "PET-002", customerId: "CUST-001", name: "Max", type: "Dog", breed: "Labrador", age: "5 years", image: "https://picsum.photos/seed/dog2/100/100" },
    { id: "PET-003", customerId: "CUST-002", name: "Luna", type: "Cat", breed: "Persian", age: "2 years", image: "https://picsum.photos/seed/cat1/100/100" },
    { id: "PET-004", customerId: "CUST-003", name: "Charlie", type: "Dog", breed: "German Shepherd", age: "4 years", image: "https://picsum.photos/seed/dog3/100/100" },
    { id: "PET-005", customerId: "CUST-004", name: "Whiskers", type: "Cat", breed: "Siamese", age: "1 year", image: "https://picsum.photos/seed/cat2/100/100" },
    { id: "PET-006", customerId: "CUST-005", name: "Bella", type: "Dog", breed: "Poodle", age: "6 years", image: "https://picsum.photos/seed/dog4/100/100" },
    { id: "PET-007", customerId: "CUST-005", name: "Duke", type: "Dog", breed: "Bulldog", age: "2 years", image: "https://picsum.photos/seed/dog5/100/100" },
  ]);
  ...
  const filteredCustomers = customers.filter(customer => {
    ...
    if (filterType === "recent") return matchesSearch && new Date(customer.joinDate) > new Date(Date.now() - 30 * 24 * 60 * 60 * 1000);
    if (filterType === "active") return matchesSearch && customer.totalBookings > 10;
  ...
  const handleCustomerSubmit = (e) => {
    ...
    const newCustomer = {
      ...
      address: customerFormData.address ? 
        `${customerFormData.address}, ${customerFormData.city || ''}, ${customerFormData.state || ''} ${customerFormData.zipCode || ''}`.replace(/,\s*,/g, ',').trim() : 
        "",
  ...
  const handlePetSubmit = (e) => {
    ...
    const newPet = {
      ...
      ...petFormData,
      image: `https://picsum.photos/seed/${petFormData.name}/100/100`
    };
    ...
    <div className="customers-profile">
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card">
          ...
          <div className="stat-content">
            <h3>{Math.round(customers.reduce((sum, c) => sum + c.totalBookings, 0) / customers.length)}</h3>
